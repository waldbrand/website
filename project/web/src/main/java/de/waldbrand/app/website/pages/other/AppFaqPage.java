...
public class AppFaqPage extends SimpleBaseGenerator
{

	public AppFaqPage(WebPath path)
	{
		super(path);
	}
	...
	{
		content.ac(HTML.h1("FAQ zur Android-App"));

		Div deck = content.ac(HTML.div("row"));

		card(deck, "markdown/de/app-faq.md");
